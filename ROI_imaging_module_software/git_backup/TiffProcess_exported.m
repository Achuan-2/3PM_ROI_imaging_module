classdef TiffProcess_exported < matlab.apps.AppBase
    ...
    properties (Access = public)
        ...
        RemoverandomnoiseCheckBox       matlab.ui.control.CheckBox
        ...
        Ref_imgLabel                    matlab.ui.control.Label
    ...
    methods (Access = private)
        ...
        function split_channel(app,filepath,folderProcessed,nChannels,progressDlg)
            ...
            for i = 1:nChannels
               ...
               % 5. Remove random noise
                if app.RemoverandomnoiseCheckBox.Value
        ...
        function RunButton_ROIRebuildPushed(app, event)
            ...
            app.fpa_reconstruct(app.roiRebuildPath,true);
        end
        ...
        function rebuiltPath = fpa_reconstruct(app,filepath,needReg)
            arguments
                app
                filepath
                needReg = false;
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            % Create RemoverandomnoiseCheckBox
            app.RemoverandomnoiseCheckBox = uicheckbox(app.SplitandprocessTab);
            app.RemoverandomnoiseCheckBox.Text = 'Remove random noise';
            app.RemoverandomnoiseCheckBox.Position = [35 77 143 22];
            ...
            app.OutputFolderEditFieldLabel_3.Text = 'Save ref_img';

            % Create Ref_imgLabel
            app.Ref_imgLabel = uilabel(app.RegTab);
            app.Ref_imgLabel.FontWeight = 'bold';
            app.Ref_imgLabel.Position = [20 293 52 22];
            app.Ref_imgLabel.Text = 'Ref_img';
