classdef RIMAMotionEsitimator < scanimage.interfaces.IMotionEstimator
    ...
    %% Lifecycle
    methods
        function obj=RIMAMotionEsitimator(referenceRoiData)
    ...
    methods (Static)
        function obj = loadobj(s)
            obj = scanimage.components.motionEstimators.RIMAMotionEsitimator(s.roiData);
            obj.enable = s.enable;
