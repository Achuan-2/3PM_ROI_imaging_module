classdef AwgSettings_exported < matlab.apps.AppBase
    ...
    properties (Access = public)
        AWGSettingsUIFigure           matlab.ui.Figure
    ...
    methods (Access = private)
        ...
        function startupFcn(app, MainApp)
            app.MainApp = MainApp;
            app.AWGSettingsUIFigure.Position = [app.MainApp.RoiImagingModuleUIFigure.Position(1)+app.MainApp.RoiImagingModuleUIFigure.Position(3)+5,...
                app.MainApp.RoiImagingModuleUIFigure.Position(2)+310,...
                470,...
                388];
        ...
        % Close request function: AWGSettingsUIFigure
        function AWGSettingsUIFigureCloseRequest(app, event)
            app.MainApp.AwgSettingsApp = 0;
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            % Create AWGSettingsUIFigure and hide until all components are created
            app.AWGSettingsUIFigure = uifigure('Visible', 'off');
            app.AWGSettingsUIFigure.Position = [100 100 306 310];
            app.AWGSettingsUIFigure.Name = 'AWG Settings';
            app.AWGSettingsUIFigure.CloseRequestFcn = createCallbackFcn(app, @AWGSettingsUIFigureCloseRequest, true);

            % Create DeviceIDEditFieldLabel
            app.DeviceIDEditFieldLabel = uilabel(app.AWGSettingsUIFigure);
            app.DeviceIDEditFieldLabel.Position = [7 281 57 22];
            app.DeviceIDEditFieldLabel.Text = 'Device ID';

            % Create DeviceIDEditField
            app.DeviceIDEditField = uieditfield(app.AWGSettingsUIFigure, 'text');
            ...
            app.TriggerModeLabel = uilabel(app.AWGSettingsUIFigure);
            app.TriggerModeLabel.Position = [7 243 76 22];
            app.TriggerModeLabel.Text = 'Trigger Mode';

            % Create ArbModeDropDown
            app.ArbModeDropDown = uidropdown(app.AWGSettingsUIFigure);
            ...
            app.SampleRateEditFieldLabel = uilabel(app.AWGSettingsUIFigure);
            ...
            app.SampleRateEditField = uieditfield(app.AWGSettingsUIFigure, 'numeric');
            ...
            app.GainEditFieldLabel = uilabel(app.AWGSettingsUIFigure);
            app.GainEditFieldLabel.Position = [8 131 50 22];
            app.GainEditFieldLabel.Text = 'Gain (V)';

            % Create ArbGainEditField
            app.ArbGainEditField = uieditfield(app.AWGSettingsUIFigure, 'numeric');
            ...
            app.ArbOffsetEditFieldLabel = uilabel(app.AWGSettingsUIFigure);
            app.ArbOffsetEditFieldLabel.Position = [8 94 56 22];
            app.ArbOffsetEditFieldLabel.Text = 'Offset (V)';

            % Create ArbOffsetEditField
            app.ArbOffsetEditField = uieditfield(app.AWGSettingsUIFigure, 'numeric');
            ...
            app.SampleClockLabel = uilabel(app.AWGSettingsUIFigure);
            app.SampleClockLabel.Position = [7 205 89 22];
            app.SampleClockLabel.Text = 'Sampling Clock';

            % Create SampleClockDropDown
            app.SampleClockDropDown = uidropdown(app.AWGSettingsUIFigure);
            ...
            app.AwgExternalClockPort = uieditfield(app.AWGSettingsUIFigure, 'text');
            app.AwgExternalClockPort.HorizontalAlignment = 'center';
            app.AwgExternalClockPort.Position = [237 206 60 21];
            app.AwgExternalClockPort.Value = 'ClkIn';

            % Create AwgTriggerPort
            app.AwgTriggerPort = uieditfield(app.AWGSettingsUIFigure, 'text');
            ...
            app.ExportSignalPort = uieditfield(app.AWGSettingsUIFigure, 'text');
            ...
            app.SignalTypeDropDown = uidropdown(app.AWGSettingsUIFigure);
            ...
            app.ExternalTriggerDropDownLabel = uilabel(app.AWGSettingsUIFigure);
            ...
            app.ExternalTriggerDropDown = uidropdown(app.AWGSettingsUIFigure);
            ...
            app.DelaynsEditFieldLabel = uilabel(app.AWGSettingsUIFigure);
            app.DelaynsEditFieldLabel.Position = [8 20 60 22];
            app.DelaynsEditFieldLabel.Text = 'Delay (ns)';

            % Create DelaynsEditField
            app.DelaynsEditField = uieditfield(app.AWGSettingsUIFigure, 'numeric');
            ...
            app.ExportSignalDropDownLabel = uilabel(app.AWGSettingsUIFigure);
            ...
            app.ExportSignalDropDown = uidropdown(app.AWGSettingsUIFigure);
            ...
            app.AWGSettingsUIFigure.Visible = 'on';
        end
    end
    ...
    methods (Access = public)
        ...
        function app = AwgSettings_exported(varargin)
            ...
            if isempty(runningApp)
                ...
                registerApp(app, app.AWGSettingsUIFigure)
                ...
                figure(runningApp.AWGSettingsUIFigure)
        ...
        function delete(app)
            ...
            delete(app.AWGSettingsUIFigure)
        end
    end
end